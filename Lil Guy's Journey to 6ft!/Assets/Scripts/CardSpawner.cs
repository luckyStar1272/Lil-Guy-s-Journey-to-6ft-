...
public class CardSpawner : MonoBehaviour
{
    ...
    void Start() {
        SpawnCard("player deck");
    }

    //instantiates or spawns a card prefab clone.
    public void SpawnCard(String deckType) {
        ...
        switch(deckType) {
            ...
            case "player deck":
                ...
                //sets card as a child to content, horizontal layout group, and content size fitter in player deck scroll view.
                newCard.transform.SetParent(playerDeckContent, false);
                playerDeckContent.transform.localScale = new Vector3(250f, 250f, 250f);
                break;
